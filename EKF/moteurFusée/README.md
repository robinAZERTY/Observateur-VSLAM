...
- $X = \begin{bmatrix} T_{com} \\ T_{cap} \end{bmatrix}$ : vecteur d'état du système, avec $T_{com}$ la température dans la chambre de combustion, et $T_{cap}$ la température au niveau du compartiment capteur.
